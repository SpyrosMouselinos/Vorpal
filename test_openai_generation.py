#!/usr/bin/env python3
"""
Test the OpenAI API caption generation with a few examples before running the full dataset.
...
try:
    ...
    print("Error: Please install openai library:")
...
def test_generation():
    ...
    # Test cases
    test_cases = [
        ("Urban & City Life", "Bustling Street Markets & Bazaars"),
        ("Space & Astronomy", "Rocket Launches & Space Shuttles"),
        ("Pets & Domestic Animals", "Dogs Playing Fetch"),
        ("Entertainment & Music", "Rock Concerts & Music Festivals"),
    ]
    
    print("="*70)
    print("TESTING GPT-4O-MINI CAPTION GENERATION")
    print("="*70)
